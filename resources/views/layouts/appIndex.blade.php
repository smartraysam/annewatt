            ...
            <div class="collapse navbar-collapse" id="navbarsExample03">
                ...
                <form class="form-inline my-2 my-md-0 navbar-search">
                    <div class="input-group md-form form-sm form-2 pl-0">
                        <input class="form-control my-0 py-1 lime-border" type="text" placeholder="Enter Rider ID..."
                            aria-label="Search" aria-describedby="basic-addon2" id="rideridheader">
                        <div class="input-group-append">
                            <span class="input-group-text view-rider lime lighten-2" type="button" id="basic-text1"><i
                                    class="fas fa-search fa-sm text-grey" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </form>
